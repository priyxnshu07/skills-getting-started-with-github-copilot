...
activities = {
    ...
    "Debate Team": {
        ...
        "max_participants": 20,
        "participants": ["alex@mergington.edu", "maya@mergington.edu", "ryan@mergington.edu"],
        "category": "Academic"
    },
    "Basketball Team": {
        ...
        "max_participants": 25,
        "participants": ["jake@mergington.edu", "lisa@mergington.edu", "tom@mergington.edu", "anna@mergington.edu"],
        "category": "Sports"
    }
}
...
def withdraw_from_activity(activity_name: str, email: str):
    ...
    if email not in activity["participants"]:
        raise HTTPException(status_code=400, detail="Student is not enrolled in this activity")
